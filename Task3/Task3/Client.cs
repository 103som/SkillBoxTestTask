...
namespace Task3
{
    ...
    internal class Client
    {
        ...
        [JsonPropertyName("Время последнего изменения данных")]
        public string? TimeDataChanged { get; set; } = null;

        [JsonPropertyName("Измененные данные")]
        public string? LastChangedData { get; set; } = null;

        [JsonPropertyName("Изменил данные конусальтант или нет")]
        public bool? IsConsultantChanged { get; set; } = null;
        /// <summary>
        ...
        public Client(string surname, string name, string patronymic, string phoneNumber, string documentData, string id)
        {
            ...
            Id = id;
            TimeDataChanged = Bank.stopWatch.ToString();
        }
